...
Begin VB.Form frmMntFpa 
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":0000
      PICN            =   "frmMntFpa.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":0D0A
      PICN            =   "frmMntFpa.frx":0D26
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":19F8
      PICN            =   "frmMntFpa.frx":1A14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":274A
      PICN            =   "frmMntFpa.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":3440
      PICN            =   "frmMntFpa.frx":345C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":3D36
      PICN            =   "frmMntFpa.frx":3D52
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":45B0
      PICN            =   "frmMntFpa.frx":45CC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":4EA6
      PICN            =   "frmMntFpa.frx":4EC2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":5A94
      PICN            =   "frmMntFpa.frx":5AB0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFpa.frx":67E6
      PICN            =   "frmMntFpa.frx":6802
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
...
If Not prime Then
 If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran Formas de Pago. ¿Crear?", vbYesNo + vbQuestion, "Formas de Pago") = vbNo Then
        Unload Me
        Else
...
Private Sub cbAgregar_Click()
 Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from FPAGO")
