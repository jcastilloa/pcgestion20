...
Begin VB.Form frmFlexCol 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Consulta de Colores"
   ClientHeight    =   5265
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   9675
   ...
   Begin VSFlex8Ctl.VSFlexGrid fg 
      ...
      FormatString    =   $"frmFlexCol.frx":0000
      ScrollTrack     =   0   'False
      ScrollBars      =   3
      ScrollTips      =   0   'False
      MergeCells      =   0
...
Dim Row As Long
    ...
    For Row = 1 To fg.Rows - 1
        fg.Cell(flexcpBackColor, Row, 3, Row, 3) = fg.ValueMatrix(Row, 3)
        fg.Cell(flexcpForeColor, Row, 3, Row, 3) = fg.ValueMatrix(Row, 3)
     Next Row
