...
Begin VB.Form frmMntFam 
   ...
   Begin PCGestion.miText ioDescripcion 
      ...
      EsPassword      =   -1  'True
   End
   Begin PCGestion.miCombo cbSECCIONES 
      Height          =   450
      Left            =   1500
      TabIndex        =   0
      Top             =   495
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":0000
      PICN            =   "FrmFamilias.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":0CEE
      PICN            =   "FrmFamilias.frx":0D0A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":1A5C
      PICN            =   "FrmFamilias.frx":1A78
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":274A
      PICN            =   "FrmFamilias.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":349C
      PICN            =   "FrmFamilias.frx":34B8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":4192
      PICN            =   "FrmFamilias.frx":41AE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":4A88
      PICN            =   "FrmFamilias.frx":4AA4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":5302
      PICN            =   "FrmFamilias.frx":531E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":5BF8
      PICN            =   "FrmFamilias.frx":5C14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmFamilias.frx":67E6
      PICN            =   "FrmFamilias.frx":6802
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
...
'/////////////////////////////////////////////
' Validación Externa para cbsecciones
'/////////////////////////////////////////////
Private Sub cbsecciones_Validate(Cancel As Boolean)

If mbEditFlag Or mbAddNewFlag Or mbDataChanged Then
'si esta a blanco, cancelar validación
If Trim(cbSECCIONES.Text = "") Then
    Cancel = True
End If
...
If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran familias. ¿Crear?", vbYesNo + vbQuestion, "Familias") = vbNo Then
        Unload Me
        Else
...
Private Sub Form_Load()
  ...
  Move (Screen.Width - Width) \ 2, Separacion_MDIForm
    ...
    'si no se ha realizado la conexion
   With locCnn
    If .State = 0 Then
  ...
  oSQL.AddTable "FAMILIAS"
  oSQL.AddOrderClause "CODSEC"
...
tmprc.Open "SELECT CODIGO, DESCRIPCION FROM SECCIONES WHERE MBAJA = 0 ORDER BY CODIGO", locCnn, adOpenDynamic, adLockReadOnly
...
Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from familias")
...
GoFirstError:
'operacion cancelada de micombo
