...
'Public Sub gfDrawGradient(hWnd&, lColor1&, lColor2&, lAngle&, lPerc&)
'    If lPerc < 0& Or lPerc > 100& Then lPerc = 50&
'
'
'End Sub
...
Public Function fGetGradientColorRatio(ByVal lColor As OLE_COLOR, _
                                       ...
                                       Boost0 As Boolean) _
                                       As OLE_COLOR
    Dim lC1&, lC2&, lC3&, lCC1&, lCC2&, lCC3&, a1&, a2&, b1&, b2&
    Const con255& = 255&
    Const con0& = 0&
...
'        lC3 = CLng(lC3 * dRatio)
'
'        If lC1 > 255 Then lC1 = 255
'        If lC2 > 255 Then lC2 = 255
'        If lC3 > 255 Then lC3 = 255
        
'        fGetGradientColorRatio = RGB(CLng(lC1 * dRatio), CLng(lC2 * dRatio), CLng(lC3 * dRatio))
