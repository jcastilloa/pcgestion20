...
Begin VB.Form frmMntFco 
   ...
   Begin PCGestion.miText ioDescripcion 
      ...
      EsPassword      =   -1  'True
   End
   Begin PCGestion.miCombo cbPRIMERA 
      Height          =   525
      Left            =   1500
      TabIndex        =   1
      Top             =   975
      ...
      EndProperty
   End
   Begin PCGestion.miCombo cbSEGUNDA 
      Height          =   525
      Left            =   1500
      TabIndex        =   2
      Top             =   1440
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":0000
      PICN            =   "frmMntFco.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":0CEE
      PICN            =   "frmMntFco.frx":0D0A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":1A5C
      PICN            =   "frmMntFco.frx":1A78
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":274A
      PICN            =   "frmMntFco.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":349C
      PICN            =   "frmMntFco.frx":34B8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":4192
      PICN            =   "frmMntFco.frx":41AE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":4A88
      PICN            =   "frmMntFco.frx":4AA4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":5302
      PICN            =   "frmMntFco.frx":531E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":5BF8
      PICN            =   "frmMntFco.frx":5C14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntFco.frx":67E6
      PICN            =   "frmMntFco.frx":6802
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
...
If Not prime Then
  ...
  If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran Formas de Cobro. ¿Crear?", vbYesNo + vbQuestion, "Formas de Cobro") = vbNo Then
        Unload Me
        Else
...
Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from FCOBRO")
...
Private Sub cbedicion_Click()
  ...
  'no dejar modificar las formas de pago predefinidas en el sistema
  If rc.fields("CODIGO") <= 5 Then
    lblstatus.Caption = "No se puede modificar las forma de pago"
    Exit Sub
  End If
...
Private Sub SetButtons(bVal As Boolean)
  ...
  cbPRIMERA.Locked = bVal
  cbSEGUNDA.Locked = bVal
End Sub
