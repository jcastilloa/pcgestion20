...
Begin VB.Form frmMntTall 
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":0000
      PICN            =   "frmMntTall.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":0CEE
      PICN            =   "frmMntTall.frx":0D0A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":1A5C
      PICN            =   "frmMntTall.frx":1A78
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":274A
      PICN            =   "frmMntTall.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":349C
      PICN            =   "frmMntTall.frx":34B8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":4192
      PICN            =   "frmMntTall.frx":41AE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":4A88
      PICN            =   "frmMntTall.frx":4AA4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":5302
      PICN            =   "frmMntTall.frx":531E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":5BF8
      PICN            =   "frmMntTall.frx":5C14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntTall.frx":67E6
      PICN            =   "frmMntTall.frx":6802
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
...
If Not prime Then
  ...
  If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran Tallas. ¿Crear?", vbYesNo + vbQuestion, "Tallas") = vbNo Then
        Unload Me
        Else
...
If rc.EditMode = adEditNone Or Not mbDataChanged Then
    ...
    With frmFlexSimple
        ...
        With .fg
                Set .DataSource = rc
                .ColFormat(1) = "000"
                tmprs.Open "SELECT CODIGO, DESCRIPCION FROM CATTALL ORDER BY CODIGO", locCnn, adOpenDynamic, adLockReadOnly
                tmpstrcombo = .BuildComboList(tmprs, "DESCRIPCION", "CODIGO", vbBlue)
...
Private Sub rc_WillChangeRecord(ByVal adReason As ADODB.EventReasonEnum, ByVal cRecords As Long, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  ...
  Case adRsnUpdate, adRsnAddNew
        ...
        If Trim(cbCATTALL.Text) = "" Then
            lblstatus.Caption = "La Categoría no puede estar en blanco"
            cbCATTALL.SetFocus
            bCancel = True
        End If
...
Private Sub cbAgregar_Click()
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from tallas")
    
    
    If tmpcodigo = "@" Then tmpcodigo = 1
    
        'no permitir mas de 99 tallas (hasta que tenga que quitar el
        'limite de la longitud del codigo de barras
        If tmpcodigo > 99 Then
            lblstatus.Caption = "Límite de 99 Tallas"
            Exit Sub
        End If
