...
Begin VB.Form frmMntIva 
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":0000
      PICN            =   "frmMntIva.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":0D0A
      PICN            =   "frmMntIva.frx":0D26
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":19F8
      PICN            =   "frmMntIva.frx":1A14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":274A
      PICN            =   "frmMntIva.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":3440
      PICN            =   "frmMntIva.frx":345C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":3D36
      PICN            =   "frmMntIva.frx":3D52
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":45B0
      PICN            =   "frmMntIva.frx":45CC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":4EA6
      PICN            =   "frmMntIva.frx":4EC2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":5A94
      PICN            =   "frmMntIva.frx":5AB0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntIva.frx":678A
      PICN            =   "frmMntIva.frx":67A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentra IVA. ¿Crear?", vbYesNo + vbQuestion, "IVA") = vbNo Then
        Unload Me
        Else
...
Private Sub rc_WillChangeRecord(ByVal adReason As ADODB.EventReasonEnum, ByVal cRecords As Long, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  ...
  Case adRsnUpdate
        ...
        If ioIVA.Text = "" Then
            lblstatus.Caption = "IVA no puede estar en blanco"
            ioIVA.SetFocus
            bCancel = True
        End If
  
        If ioRE.Text = "" Then
            lblstatus.Caption = "RE no puede estar en blanco"
            ioRE.SetFocus
            bCancel = True
        End If
...
Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from IVA")
