...
Begin VB.Form frmMntSct 
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":0000
      PICN            =   "frmMntStc.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":0D0A
      PICN            =   "frmMntStc.frx":0D26
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":19F8
      PICN            =   "frmMntStc.frx":1A14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":274A
      PICN            =   "frmMntStc.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":3440
      PICN            =   "frmMntStc.frx":345C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":3D36
      PICN            =   "frmMntStc.frx":3D52
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":45B0
      PICN            =   "frmMntStc.frx":45CC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":4EA6
      PICN            =   "frmMntStc.frx":4EC2
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":5A94
      PICN            =   "frmMntStc.frx":5AB0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmMntStc.frx":678A
      PICN            =   "frmMntStc.frx":67A6
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub Form_Activate()
 ...
 If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran Sectores. ¿Crear?", vbYesNo + vbQuestion, "Sectores") = vbNo Then
        Unload Me
        Else
...
Private Sub Form_Load()
  ...
  oSQL.AddTable "SECTORES"
  oSQL.AddOrderClause "CODST"
...
Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codst) + 1 from sectores")

    If tmpcodigo = "@" Then tmpcodigo = 1
    
    .fields("CODST") = tmpcodigo
