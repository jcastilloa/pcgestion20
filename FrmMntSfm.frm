...
Begin VB.Form frmMntSfm 
   ...
   Begin PCGestion.miText ioDescripcion 
      ...
      EsPassword      =   -1  'True
   End
   Begin PCGestion.miCombo cbFAMILIAS 
      Height          =   525
      Left            =   1500
      TabIndex        =   0
      Top             =   510
   ...
   Begin PCGestion.chameleonButton cmdPrevious 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":0000
      PICN            =   "FrmMntSfm.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdFirst 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":0CEE
      PICN            =   "FrmMntSfm.frx":0D0A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdNext 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":1A5C
      PICN            =   "FrmMntSfm.frx":1A78
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cmdLast 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":274A
      PICN            =   "FrmMntSfm.frx":2766
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   1
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbAgregar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":349C
      PICN            =   "FrmMntSfm.frx":34B8
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbActualizar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":4192
      PICN            =   "FrmMntSfm.frx":41AE
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEdicion 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":4A88
      PICN            =   "FrmMntSfm.frx":4AA4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCancelar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":5302
      PICN            =   "FrmMntSfm.frx":531E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbEliminar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":5BF8
      PICN            =   "FrmMntSfm.frx":5C14
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin PCGestion.chameleonButton cbCerrar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "FrmMntSfm.frx":67E6
      PICN            =   "FrmMntSfm.frx":6802
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
...
'/////////////////////////////////////////////
' Validación Externa para cbfamilias
'/////////////////////////////////////////////
Private Sub cbfamilias_Validate(Cancel As Boolean)

If mbEditFlag Or mbAddNewFlag Or mbDataChanged Then
'si esta a blanco, cancelar validación
If Trim(cbFAMILIAS.Text = "") Then
    Cancel = True
End If
...
If rc.RecordCount = 0 Then
        ...
        If MsgBox("No se encuentran Subfamilias. ¿Crear?", vbYesNo + vbQuestion, "Subfamilias") = vbNo Then
        Unload Me
        Else
...
tmprc.Open "SELECT CODIGO, DESCRIPCION FROM FAMILIAS WHERE MBAJA = 0 ORDER BY CODIGO", locCnn, adOpenDynamic, adLockReadOnly
...
Dim tmpcodigo As Variant
  ...
  With rc
    ...
    tmpcodigo = devuelve_campo("select max(codigo) + 1 from SUBFAM")
